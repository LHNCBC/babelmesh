    ...
    <div class="usa-layout padding-y-4">
      <div class="grid-row grid-gap">
        ...
        <div class="desktop:grid-col-9">
          <p>BABELMESH</p>
          <h2>  ﺎﻠﺒﺤﺛ ﺏﺎﻠﻠﻏﺓ ﺎﻠﻋﺮﺒﻳﺓ ﻒﻳ ﻢﻳﺩﻼﻴﻧ MEDLINE / PubMed</h2>
...
?>
<p class="Normal" dir="RTL" style="text-align: right; direction: rtl; unicode-bidi: embed">

<font size="2"> 
 من الأسهل عند البحث عن المعلومات استخدام اللغة التي يألفها الفرد، وربما تساعد ترجمات رؤوس الموضوعات الطبية "<a href=http://www.nlm.nih.gov/pubs/factsheets/mesh.html >MeSH</a>" الأفراد الذين لا يعرفون اللغة الإنجليزية. 
</font>
<p class="Normal" dir="RTL" style="text-align: right; direction: rtl; unicode-bidi: embed">
<b>ادخل المصطلح الطبي أو العبارة الطبية باللغة العربية:</b></br>
</p>
...
<form  accept-charset="utf-8" method="POST" name ="ara" id="query" action=<?php echo $_SERVER['PHP_SELF']."?com=$com"; ?>>
<p class="Normal" dir="RTL" style="text-align: right; direction: rtl; unicode-bidi: embed">
  ...
  <button class="g-recaptcha" 
        ...
        data-action='submit'>ﺈﺒﺤﺛ</button>
  <!--<input type="submit" value="إبحث" name="B1">-->
	&nbsp;<input type="reset" value="إمسح" name="B2">
</p>
<p class="Normal" dir="RTL" style="text-align: right; direction: rtl; unicode-bidi: embed">
<font size="2" color="#0000FF">اختر لغة الادخال:<br></font>

<font size="2" color="#0000FF">[<span id="s_ara_o">العربية</span><input type="checkbox" value="ARA" name="ARA_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_chn_o">الصينية</span><input type="checkbox" value="CHN" name="CHN_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_fre_o">الفرنسية</span><input type="checkbox" value="FRE" name="FRE_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_ger_o">الألمانية</span><input type="checkbox" value="GER" name="GER_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_ita_o">الإيطالية</span><input type="checkbox" value="ITA" name="ITA_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_jpn_o">اليابانية</span><input type="checkbox" value="JPN" name="JPN_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_kor_o">اللغة الكورية</span><input type="checkbox" value="KOR" name="KOR_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_por_o">البرتغالية</span><input type="checkbox" value="POR" name="POR_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_rus_o">الروسية</span><input type="checkbox" value="RUS" name="RUS_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_spa_o">الأسبانية</span><input type="checkbox" value="SPA" name="SPA_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_swe_o">اللغة السويدية</span><input type="checkbox" value="SWE" name="SWE_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_eng_o">الإنجليزية</span><input type="checkbox" value="ENG" name="ENG_o">]&nbsp;&nbsp;&nbsp;</font>
<font size="2" color="#0000FF">[<span id="s_all_o">جميع اللغات</span><input type="checkbox" value="ALL" name="ALL_o">]</font>
...
<SCRIPT>InstallAC(document.ara,document.ara.terms,document.ara.B1,"search","en","ARA");</SCRIPT>
<?php
	}
  elseif ($_POST["checked"] == 1){
		$ooterm = $_POST["terms"];
  		...
  		$db_object = db_connect($db_name);
			...
			$query = "SELECT US_DESCRIPTOR FROM ara_mesh WHERE ara_descriptor ='".addslashes($_POST["terms"])."'";
      ...
      $ip = get_client_ip();
	  	if ($checked == 1) {
				 ...
				 $content .= "Arabic: ".$_POST["terms"]." -- ".$rterm;
...
<form enctype="application/x-www-form-urlencoded" name="query2" action="search.php?from=ara&com=<?php echo $com;?>&term=<?php echo $term; ?>" method="POST">
...
<?php
         ...
         $lang= 'ara';
				   ...
				   $result = $find->lang_finder(addslashes(str_replace($de_chars, " ", $_POST["terms"]) ), $lang, $lang_table, $lang_column, $eng_column);
					 ...
					 if(sizeof($result) != 0) {
					   $FINDER = 1;
						 ...
						 $query = "SELECT ARA_DESCRIPTOR, US_DESCRIPTOR FROM ara_mesh WHERE ARA_DESCRIPTOR like '%".addslashes($_POST["terms"])."%' GROUP BY US_DESCRIPTOR";
	  		 		 $result = mysqli_query($db_object, $query); //or die("Query failed :" );
				 		 if (mysqli_affected_rows($db_object) == 0) {
							   $result=$find->topLang(addslashes($_POST["terms"]), $lang, $lang_table, $lang_column, $eng_column);
							 	 if (mysqli_affected_rows($db_object)==0) {
							  	 echo "Sorry, this term is not in our database.<br>";
									 echo "<p><form action=search.php?from=ara&com=$com method=POST>".$ooterm." = <input value=\"".$ooterm."\" size=25 name=terms> ";
				 ...
				 if ($FINDER == 1) {
				   $term = implode(" ", $result);		 
					 echo "<form enctype=\"application/x-www-form-urlencoded\" name=\"query\" action=\"search.php?from=ara&com=$com\" method=\"POST\">";	
				   ...
				   while ($line= mysqli_fetch_array($result)) {	
				 	   $term = $line["US_DESCRIPTOR"];
					 	 $term1 = $term;
						 $term = str_replace(' ', '+',$term);
						 $temp = $line["ARA_DESCRIPTOR"];
						 echo "<form enctype=\"application/x-www-form-urlencoded\" name=\"query\" action=\"search.php?from=ara&com=$com\" method=\"POST\">";
						 echo "<li>".str_replace($ooterm, "<B style=\"color:black;background-color:#ffff66\">".$ooterm."</B>", mb_convert_encoding($line["ARA_DESCRIPTOR"], "CP1252"));
